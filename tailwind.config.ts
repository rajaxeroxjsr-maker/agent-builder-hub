...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        glow: "0 0 20px hsl(var(--glow-primary) / 0.3), 0 0 60px hsl(var(--glow-primary) / 0.1)",
        "glow-lg": "0 0 30px hsl(var(--glow-primary) / 0.4), 0 0 80px hsl(var(--glow-primary) / 0.2)",
        soft: "0 2px 20px hsl(var(--foreground) / 0.04)",
        elevated: "0 8px 30px hsl(var(--foreground) / 0.08), 0 2px 8px hsl(var(--foreground) / 0.04)",
      },
      keyframes: {
        "accordion-down": {
